...
``` r
proteomics_data <- read.table("data/R-proteomics-Nrf1.csv", header=TRUE, sep=",")
...
with(subset(proteomics_data, pvalue<.05),
     points(
       log2_FC_HAchol_HAchow,
       -log10(pvalue),
       pch=20,
...
with(subset(proteomics_data, abs(log2_FC_HAchol_HAchow)>1),
     points(
       log2_FC_HAchol_HAchow,
       -log10(pvalue),
       pch=20,
...
with(subset(proteomics_data, pvalue<.05 & abs(log2_FC_HAchol_HAchow)>1),
     points(
       log2_FC_HAchol_HAchow,
       -log10(pvalue),
       pch=20,
...
![](R-proteomics-Nrf1_files/figure-markdown_github/unnamed-chunk-2-1.png)
...
# Add colored points:
# red if pvalue<0.05, orange if log2FC>1, green if both)
with(subset(proteomics_data, pvaluebort<.05 ),
     points(
       log2_FC_HAbort_HAchow,
       -log10(pvaluebort),
       pch=20,
...
with(subset(proteomics_data, abs(log2_FC_HAbort_HAchow)>1),
     points(
       log2_FC_HAbort_HAchow,
       -log10(pvaluebort),
       pch=20,
...
with(subset(proteomics_data, pvaluebort<.05 & abs(log2_FC_HAbort_HAchow)>1),
     points(
       log2_FC_HAbort_HAchow,
       -log10(pvaluebort),
       pch=20,
...
![](R-proteomics-Nrf1_files/figure-markdown_github/unnamed-chunk-3-1.png)
...
# Add colored points:
# red if pvalue<0.05, orange if [log2FC]>1, green if both)
with(subset(proteomics_data, pvaluechow<.05),
     points(
       log2_FC_HAchow_lacZ,
       -log10(pvaluechow),
       pch=20,
...
with(subset(proteomics_data, abs(log2_FC_HAchow_lacZ)>1),
     points(
       log2_FC_HAchow_lacZ,
       -log10(pvaluechow),
       pch=20,
...
with(subset(proteomics_data, pvaluechow<.05 & abs(log2_FC_HAchow_lacZ)>1),
     points(
       log2_FC_HAchow_lacZ,
       -log10(pvaluechow),
       pch=20,
...
![](R-proteomics-Nrf1_files/figure-markdown_github/unnamed-chunk-4-1.png)
...
![](R-proteomics-Nrf1_files/figure-markdown_github/unnamed-chunk-5-1.png)
